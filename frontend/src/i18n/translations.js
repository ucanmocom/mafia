export const translations = {
  pl: {
    ...
    roleHints: {
      mafia: 'Każdej nocy musi wybrać i zabić osobę. Mafia wie kim są pozostali gracze Mafii.',
    ...
    lobby: {
      ...
      kickTitle: 'Wyrzuć',
      tooManyMafia: 'Więcej niż 1 Mafia wymaga 6+ graczy ({n} teraz)',
      lovers: 'Zakochani',
      timers: 'Czasomierze',
  ...
  fr: {
    ...
    home: {
      ...
      winConditionDesc: 'Les villageois gagnent lorsqu\'ils découvrent et éliminent tous les membres de la mafia. La mafia gagne lorsque le nombre de membres de la Mafia est égal ou supérieur au nombre de joueurs restants.',
      gamble: 'Rôles',
    ...
    roleDesc: {
      mafia: 'Vous êtes membre de la mafia. Chaque nuit, avec les autres, vous choisissez une personne à éliminer. Vous gagnez quand le nombre de membres de la Mafia égale celui des autres joueurs.',
    ...
    roleHints: {
      mafia: 'Chaque nuit doit choisir et tuer une personne. Les membres de la Mafia savent qui sont les autres membres de la Mafia.',
    ...
    lobby: {
      ...
      kickTitle: 'Expulser',
      tooManyMafia: 'Plus d\'1 Mafia nécessite 6+ joueurs ({n} actuellement)',
      lovers: 'Amoureux',
      timers: 'Minuteries',
      discussion: 'Discussion (s)',
      night: 'Nuit (s)',
  ...
  de: {
    ...
    home: {
      ...
      winConditionDesc: 'Dorfbewohner gewinnen, wenn sie alle Mafia-Mitglieder entdecken und eliminieren. Die Mafia gewinnt, wenn die Anzahl der Mafia gleich oder größer ist als die Anzahl der verbleibenden Spieler.',
      gamble: 'Rollen',
    ...
    roleDesc: {
      mafia: 'Du bist Mitglied der Mafia. Jede Nacht wählt ihr gemeinsam eine Person zur Eliminierung. Du gewinnst, wenn die Anzahl der Mafia die der übrigen Spieler erreicht.',
    ...
    lobby: {
      ...
      tooManyMafia: 'Mehr als 1 Mafia erfordert 6+ Spieler ({n} jetzt)',
      lovers: 'Liebende',
      timers: 'Timer',
